...
for every episode, even if the new series covers a similar theme): paste the
contents of `figure_history.json` here before submitting this prompt, or list
the figure names manually if that file doesn't exist yet.
  ...
  "episodes": [
    {
      ...
      "sections": [
        ...
        "string — section title 3",
        "string — section title 4",
        "string — section title 5"
      ],
      "section_styles": [
        ...
        "string — speaking style for section 3",
        "string — speaking style for section 4",
        "string — speaking style for section 5"
      ]
    }
  ]
}
...
- Each episode must have exactly 5 sections (matching the 5-act dramatic structure below)
