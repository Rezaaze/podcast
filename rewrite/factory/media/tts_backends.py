...
── PROVENANCE ────────────────────────────────────────────────────────────────
Voll entkoppelte Kopie von `fabrik/audio/tts_backends.py` (produktionserprobt,
§9-„incidental": austauschbare TTS-Engine). Unverändert übernommen; braucht den
venv-Pfad (requests/pydub) und wird daher nicht von den stdlib-Unit-Tests importiert.
──────────────────────────────────────────────────────────────────────────────
