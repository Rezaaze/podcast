...

{
  ...
  "voices": {
    "NARRATOR": {
      "voice": "morgan",
      "default_style": "string — e.g. 'calm, measured, a step removed from the action' (kept for authoring clarity, but has no audible effect — see note below)",
