...
- Layer 3 (global): `templates/shorts/EPISODES_CREATOR_PROMPT.md`
...
Ausgeführt von: `python3 -m fabrik.cli.create_series "<topic>" --template shorts`
...
`python3 -m fabrik.cli.generate_episode check --series first_do_harm`
